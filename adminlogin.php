            ...
            <div class="auth-form-container">
                ...
                <form role="form" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="username" placeholder="admin" required autocomplete="off" />
                    </div>
                    ...
                    <button type="submit" name="login" class="btn-primary" style="margin-top: 2rem;">Login Dashboard</button>
