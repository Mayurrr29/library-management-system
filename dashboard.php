...
<head>
    ...
    .btn-hero-primary:hover { background: #0f3d3a; text-decoration: none; color: #fff; }
    ...
    .dash-search__input::placeholder { color: #d1d5db; }
    ...
    .dash-search__btn:hover { background: #1f2937; }
    ...
    .section-hd__link:hover { color: #0f3d3a; text-decoration: none; }
    ...
    .quick-access__link:hover { color: #111827; background: #f9f9f9; text-decoration: none; }
    ...
    .book-row::-webkit-scrollbar { height: 3px; }
    .book-row::-webkit-scrollbar-track { background: transparent; }
    .book-row::-webkit-scrollbar-thumb { background: #e4e4e4; border-radius: 10px; }
...
<div class="content-wrapper" style="background:#f7f8f8 !important; padding:0 !important; margin-top: 60px !important;">
    ...
    <div class="dash-hero">
        ...
        <div class="dash-hero__content">
            ...
            <p class="dash-hero__desc">Browse our curated collection of books across every subject. Borrow, read, and return — all from one place.</p>
                ...
                <div class="dash-search__cat">
                    <select name="cat">
                        ...
                        <?php foreach ($cats as $c): ?>
                            <option value="<?php echo htmlentities($c->id); ?>"><?php echo htmlentities($c->CategoryName); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="dash-search__input-wrap">
                    <input type="text" name="search" class="dash-search__input" placeholder="Search by title, author, or ISBN…" autocomplete="off">
                </div>
    ...
    <div class="services-strip">
        <div class="service-item">
            ...
            <div class="service-item__desc">Search thousands of books by title, author, or ISBN across all categories.</div>
        </div>
        <div class="service-item">
        ...
        <div class="service-item">
            ...
            <div class="service-item__desc">New books are added regularly. Check back often for the latest additions.</div>
        </div>
    </div>
    ...
    <div class="quick-access">
        ...
        <?php foreach (array_slice($cats, 0, 6) as $qc): ?>
            <a href="listed-books.php?cat=<?php echo $qc->id; ?>" class="quick-access__link"><?php echo htmlentities($qc->CategoryName); ?></a>
        <?php endforeach; ?>
    ...
    <div class="dash-section" style="padding-top: 0;">
        ...
        <div class="cat-grid">
            ...
            <a href="listed-books.php?cat=<?php echo $cat->id; ?>" class="cat-card">
                <img src="<?php echo $catImg; ?>" class="cat-card__img" alt="<?php echo htmlentities($cat->CategoryName); ?>">
                <div class="cat-card__body">
                    <div class="cat-card__name"><?php echo htmlentities($cat->CategoryName); ?></div>
                    <div class="cat-card__count"><?php echo $book_count; ?> <?php echo $book_count == 1 ? 'book' : 'books'; ?></div>
                </div>
            </a>
            <?php endforeach; ?>
        </div>
    ...
    <div class="about-section">
        <div class="about-section__left">
            ...
            <p class="about-section__body">Our library is a central hub for academic resources, curated to support every learner. From reference titles to course textbooks, fiction to research journals — we maintain a rich and growing collection available to all registered members.</p>
