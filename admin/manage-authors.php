    ...
    <div class="dash-container">
        ...
        <div class="dash-header">
            <div class="dash-title">
                ...
                <p>View, Edit and Delete Authors Data</p>
            </div>
            <div class="dash-search">
                <a href="add-author.php" class="filter-btn"><i class="fa fa-plus"></i> Add New Author</a>
            </div>
        </div>
...
{               ?>                                      
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center" style="font-weight:600; color:#1e293b;"><?php echo htmlentities($result->AuthorName);?></td>
                                    <td class="center"><?php echo htmlentities($result->creationDate);?></td>
                                    <td class="center"><?php echo htmlentities($result->UpdationDate);?></td>
                                    <td class="center">
                                        <div class="action-btns">
                                            <a href="edit-author.php?athrid=<?php echo htmlentities($result->id);?>" class="btn-modern btn-edit">
                                                <i class="fa fa-edit"></i> Edit
                                            </a> 
                                            <a href="manage-authors.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this author?');" class="btn-modern btn-delete">
