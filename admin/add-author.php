...
if(isset($_POST['create']))
{
    ...
    if($lastInsertId)
    {
        $success = "Author Listed successfully";
    }
    else 
    {
...
<div class="dash-container">
    ...
    <div class="dash-header">
        <div class="dash-title">
            ...
            <p>Fill in the details below to add a new author to the library</p>
        </div>
        <a href="manage-authors.php" class="back-btn"><i class="fa fa-arrow-left"></i> Back to Authors</a>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            <div class="form-card-icon"><i class="fa fa-pencil"></i></div>
            ...
            <form role="form" method="post">
                <div class="form-grid">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input class="form-control-modern" type="text" name="author" placeholder="e.g. F. Scott Fitzgerald" autocomplete="off" required />
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <a href="manage-authors.php" class="btn-cancel-modern"><i class="fa fa-times"></i> Cancel</a>
